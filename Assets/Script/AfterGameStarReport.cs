...
public class AfterGameStarReport : MonoBehaviour
{
    ...
    public void OnEnable()
    {
        ...
        RoundsElapsed.text = "Rounds Used: " + GameManager.Instance._matchManager.RoundsPlayed + " Target Rounds: " + GameManager.Instance._matchManager.CurrentLevel.TargetRounds;
    }
}
