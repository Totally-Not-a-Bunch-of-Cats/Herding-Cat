    ...
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button("Reset Levels"))
        {
            for (int i = 0; i < myScript.GameLevel.Count; i++)
            {
                ...
                if (myScript.GameLevel[i].name == "1-1" || myScript.GameLevel[i].name == "1-6" ||  myScript.GameLevel[i].name == "2-6" || myScript.GameLevel[i].name == "3-1" || myScript.GameLevel[i].name == "4-1" || myScript.GameLevel[i].name == "4-6" || myScript.GameLevel[i].name == "4-8")
                {
